defmodule MerklePatriciaTrie.Trie.Storage do
  ...
  ## Examples
    ...
    ...> |> MerklePatriciaTrie.Trie.Storage.get_node()
    ""

    iex> MerklePatriciaTrie.Trie.new(MerklePatriciaTrie.Test.random_ets_db(), <<130, 72, 105>>)
    ...> |> MerklePatriciaTrie.Trie.Storage.get_node()
    "Hi"

    iex> MerklePatriciaTrie.Trie.new(MerklePatriciaTrie.Test.random_ets_db(), <<254, 112, 17, 90, 21, 82, 19, 29, 72, 106, 175, 110, 87, 220, 249, 140, 74, 165, 64, 94, 174, 79, 78, 189, 145, 143, 92, 53, 173, 136, 220, 145>>)
    ...> |> MerklePatriciaTrie.Trie.Storage.get_node()
